...
from openvino_workbench.constants import DL_WB_LOGO, PRE_STAGE_MESSAGES, STAGE_COMPLETE_MESSAGES, INTERNAL_PORT
...
def start_container(docker_client: DockerClient,
    ...
    print_finish_message(protocol=protocol, port=config['ports'][INTERNAL_PORT][1], tokens=tokens)
